...
print("");
print("MCU-ID FILE Record N� 0:" + "  " + resp + "   " + resp.toString(ASCII));
resp = card.plainApdu(new ByteString("80 B2 01 00 08", HEX));
print("MCU-ID FILE Record N� 1:" + "  " + resp + "   " + resp.toString(ASCII));
print("");
...
resp = card.plainApdu(new ByteString("80 B2 00 00 08", HEX));
print("");
print("MANUFACTURER FILE Record N� 00:" + "  " + resp);
resp = card.plainApdu(new ByteString("80 B2 01 00 08", HEX));
print("MANUFACTURER FILE Record N� 01:" + "  " + resp);
print("");
...
print("");
print("PERSONALIZATION FILE Record N� 00:" + "  " + resp);
resp = card.plainApdu(new ByteString("80 B2 01 00 04", HEX));
print("PERSONALIZATION FILE Record N� 01:" + "  " + resp);
resp = card.plainApdu(new ByteString("80 B2 02 00 04", HEX));
print("PERSONALIZATION FILE Record N� 02:" + "  " + resp);
print("");
...
resp = card.plainApdu(new ByteString("80 B2 00 00 04", HEX));
print("ACCOUNT FILE Record N� 00:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 01 00 04", HEX));
print("ACCOUNT FILE Record N� 01:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 02 00 04", HEX));
print("ACCOUNT FILE Record N� 02:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 03 00 04", HEX));
print("ACCOUNT FILE Record N� 03:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 04 00 04", HEX));
print("ACCOUNT FILE Record N� 04:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 05 00 04", HEX));
print("ACCOUNT FILE Record N� 05:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 06 00 04", HEX));
print("ACCOUNT FILE Record N� 06:" + "  " + resp);

resp = card.plainApdu(new ByteString("80 B2 07 00 04", HEX));
print("ACCOUNT FILE Record N� 07:" + "  " + resp);
print("");
...
print("ATR FILE Record N� 00:" + "  " + resp);
